...
public class SpotProvider extends ContentProvider {
    ...
    private static HashMap<String, String> SpotMap;

    // maps content URI "patterns" to the integer values that were set above
    static final UriMatcher uriMatcher;
    static {
        uriMatcher = new UriMatcher(UriMatcher.NO_MATCH);
        uriMatcher.addURI(Constants.AUTHORITY, Constants.SPOT_TABLE, Constants.SPOTS);
        uriMatcher.addURI(Constants.AUTHORITY, Constants.SPOT_TABLE + "/#", Constants.SPOT_ID);
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case Constants.SPOTS:
                queryBuilder.setProjectionMap(SpotMap);
                break;
            case Constants.SPOT_ID:

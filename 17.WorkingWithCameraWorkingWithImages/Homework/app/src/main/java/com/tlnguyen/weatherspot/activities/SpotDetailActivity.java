 ...
 * in a {@link com.tlnguyen.weatherspot.activities.MainActivity}.
 * <p/>
 * This activity is mostly just a 'shell' activity containing nothing
 * more than a {@link com.tlnguyen.weatherspot.fragments.SpotDetailFragment}.
 */
public class SpotDetailActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putParcelable(SpotDetailFragment.SPOT,
                    getIntent().getParcelableExtra(SpotDetailFragment.SPOT));
